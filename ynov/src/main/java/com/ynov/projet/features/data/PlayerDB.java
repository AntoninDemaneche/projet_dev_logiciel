...
public class PlayerDB {
    ...
    public void updatePlayer(PlayerInfo pInfo){
        ...
        Bukkit.getScheduler().runTaskAsynchronously(Main.plugin(), () -> {
            try {
                ...
                pst.setString(11, pInfo.getChakraType()); //Removing color code
                ...
                pst.setString(22, resMapToString(pInfo));
    ...
    private PlayerInfo loadPlayerInfo(String name, ResultSet set) throws SQLException {
        ...
        String chakraType = set.getString("chakratype");
        int age = set.getInt("age");
        String apparence = set.getString("appearence");
        VoieNinja voieNinja = VoieNinja.getFromID(set.getInt("voieNinja"));
        StyleCombat styleCombat = StyleCombat.getFromID(set.getInt("styleCombat"));
        ...
        return new PlayerInfo(name, mana, manamission, manamaze, rank, skills, rollBonus, favoriteList, clan, chakraType, age, apparence, voieNinja, styleCombat, abilities, apparenceprofil, attributClan, points, pointsAbilities, delayPoints, resistance, ink, couleurChakra, teinte, oldpos, gender, fuin_paper, fuin_uzumaki, fuin_lastday, maskprofil);
    }
