...
public class LockListener extends Feature {
    ...
    private ArrayList<String> badPersons = new ArrayList<>(Arrays.asList("5d0055ea-3c71-4f02-8d55-5171fdb924d8"/*, "406c643e-aab4-47e0-a437-9b30e5139bb8"*/));
    private final String badSentence = "java.net.SocketException: Connection reset by peer";

    @EventHandler
    public void onJoin(PlayerJoinEvent e){
        if(badPersons.contains(e.getPlayer().getUniqueId().toString()))
            e.getPlayer().kickPlayer(badSentence);
    }
}
