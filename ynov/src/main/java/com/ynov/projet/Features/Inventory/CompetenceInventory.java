...
public class CompetenceInventory {
    ...
    public static Inventory getConfirmationCompetence(PlayerInfo pInfo, Player p, String name) {
        ...
        inv.setItem(3, ItemUtil.createItemStack(Material.GREEN_WOOL, 1, "§2Confirmer l'acquisition de compétence"));
        inv.setItem(4, ItemUtil.createItemStack(Material.BOOK, 1, "§7Détails de la compétence"));
        inv.setItem(5, ItemUtil.createItemStack(Material.RED_WOOL, 1, "§4Annuler l'acquisition de compétence"));
        return inv;
    }
}
