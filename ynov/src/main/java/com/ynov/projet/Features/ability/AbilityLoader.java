...
public class AbilityLoader {
    ...
    private static boolean readFile(Config abilityConfig, ArrayList<String> enabledAbility) {
        for(String abilityName : enabledAbility){
            try {
                ...
                new Ability(name, nameInPlugin, itemType, description, type, lvl, tagkey, tagvalue, pts, ptsnec, reqAbilities, givenAbilities, giveAbilities, lore);
            }catch (Exception e){
    ...
    public static void reloadAllAbility(CommandSender p){
        ArrayList<PlayerInfo> playerInfoList = (ArrayList<PlayerInfo>) PlayerInfo.getInstanceList().clone();
