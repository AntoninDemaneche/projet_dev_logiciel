package com.ynov.projet.Features.ability;
...
public class Ability {
    ...
    public Ability(String name, String nameInPlugin, Material itemType, String description, String type, int lvl, String tagkey, String tagvalue, int pts, int ptsnec, String reqAbilities, String givenAbilities, String giveAbilities, String lore){
        this.name = name;
