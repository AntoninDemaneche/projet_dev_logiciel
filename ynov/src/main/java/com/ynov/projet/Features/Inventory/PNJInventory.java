...
public class PNJInventory {
    public static Inventory getBanqueInventory(Player p){
        ...
        inv.setItem(13, ItemUtil.createItemStack(Material.ARROW, 1, ""));
        ...
        inv.setItem(22, ItemUtil.createItemStack(Material.ARROW, 1, ""));
        ...
        inv.setItem(31, ItemUtil.createItemStack(Material.ARROW, 1, ""));
        ...
        inv.setItem(40, ItemUtil.createItemStack(Material.ARROW, 1, ""));
    ...
    public static Inventory getVendeurEncre(Player p){
        ...
        inv.setItem(13, ItemUtil.createItemStack(Material.INK_SAC, 1, "§8Achat d'encre Fuinjutsu", Arrays.asList("§7Achat d'un pot d'encre contenant dix doses.", "§7Le pot coûte 100 ryos.")));
    ...
    public static Inventory getEchange(Player p){
        ...
        inv.setItem(0, ItemUtil.createItemStack(Material.GRAY_STAINED_GLASS_PANE, 1, "§8-"));
        inv.setItem(8, ItemUtil.createItemStack(Material.GRAY_STAINED_GLASS_PANE, 1, "§8-"));
        inv.setItem(6, ItemUtil.createItemStack(Material.GRAY_STAINED_GLASS_PANE, 1, "§8-"));
        inv.setItem(7, ItemUtil.createItemStack(Material.GREEN_WOOL, 1, "§5Valider l'item."));
